...
Automata.prototype.getUsedNodes = function() {
    ...
    for (var i = edges.length-1; i >= 0 ; --i) {
        ...
        if (usedNodes.indexOf(edges[i].source) < 0 || usedNodes.indexOf(edges[i].target) < 0)
            edges.splice(i, 1);
